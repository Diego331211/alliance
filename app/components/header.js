    ...
    <header className="bg-white shadow-md">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <nav
          className={`${
            isOpen ? "flex" : "hidden"
          } md:flex flex-col md:flex-row md:space-x-6 space-y-8 md:space-y-0  bg-white absolute md:relative w-full md:w-auto left-0 top-[130px] md:top-0 md:p-0 p-4 shadow-md md:shadow-none z-50 font-sans`}
        >
          <a
            href="/"
